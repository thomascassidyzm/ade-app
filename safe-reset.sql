-- SAFE RESET: Handle existing policies
-- WARNING: This will delete ALL tables and data in your database
-- Run this in your Supabase SQL Editor

-- First, drop all policies on storage.objects
DROP POLICY IF EXISTS "Allow all operations on agent files bucket" ON storage.objects;
...
DROP POLICY IF EXISTS "Allow all operations on agent_files" ON agent_files;
